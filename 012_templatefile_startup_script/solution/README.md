# 012 — Solution: templatefile() for a Startup Script

## What this creates

- The VM/network/firewall pattern from
  [011_create_vm](../011_create_vm), with one change:
...
`011_create_vm`'s heredoc works fine for a short, static script. It
