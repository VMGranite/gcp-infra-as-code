# 010 — Solution: Dynamic Blocks and Conditionals
...
[009_firewall_rules](../009_firewall_rules)'s IAP-only SSH rule, made
...
- This resource has no `target_tags`, unlike
  [009_firewall_rules](../009_firewall_rules) — worth noticing what's
