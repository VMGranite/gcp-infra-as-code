# 021 — Solution: Alerting on Manual (Non-Terraform) Changes
...
- This is a *detection*, not a *boundary* — nothing here stops the
  ...
  the same distinction [020_configuration_drift](../020_configuration_drift)
...
- Compare this alert's trust model to
  ...
  019's boundary is enforced by GCP's IAM system regardless of what
