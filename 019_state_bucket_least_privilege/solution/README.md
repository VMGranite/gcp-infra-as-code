# 019 — Solution: Least-Privilege Access to the State Bucket
...
[014_service_accounts_iam](../014_service_accounts_iam) already
...
- This is a narrower version of the same idea as
  [015_secret_manager](../015_secret_manager)'s `secret-reader`:
